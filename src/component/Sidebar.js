      ...
      <div className={`bg-teal-800 text-white w-64 ${collapsed ? 'hidden' : 'block'} transition-all duration-300`}>
        <div className="p-4">
         ...
         <Link to="/userinfo">
            ...
            <svg class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-teal-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
         ...
         <li>
          <Link to="/user">
            ...
            <svg aria-hidden="true" 
               class="flex-shrink-0 w-6 h-5 text-teal-500 transition duration-75  group-hover:text-gray-900" 
...
<button
  ...
  className={`flex items-center p-2 w-full text-base rounded-lg transition duration-75 group hover:bg-teal-700 ${
    isPagesActive ? 'bg-teal-700 dark:bg-teal-700 dark:text-white' : ''
  }`}
...
>
  <div className="flex items-center justify-between w-full">
    <div className="flex items-center">
      <svg
        aria-hidden="true"
        className={`w-6 h-6 text-teal-500 transition duration-75 ${isPagesActive ? 'dark:text-white' : ''}`}
        fill="currentColor"
        viewBox="0 0 20 20"
