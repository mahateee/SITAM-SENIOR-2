                    ...
                    <tr key={id}>
                      ...
                      <td class="p-4 text-sm font-normal text-center text-gray-500 whitespace-nowrap " style={{ width: '135px' }}>
                        <button
                          ...
                          type="button"
                          className="text-white bg-teal-800 hover:bg-teal-700 focus:ring-4 focus:ring-teal-300 font-medium rounded-lg text-sm px-5 py-2.5 ml-6 mb-2 focus:outline-none">
                          Return
                        </button>
                        <Link
                          to={`/Request/Maintenance/${asset.id}`}
                          className="text-white bg-teal-500 hover:bg-teal-600 focus:ring-4 focus:ring-teal-300 font-medium rounded-lg text-sm px-5 py-2.5 ml-6 mb-2 focus:outline-none">
                            Maintenance</Link>
                      </td>
                    </tr>
                  ))}
