      ...
      <div class="items-center justify-between lg:flex">
        ...
        <div className="flex-grow pr-10"> {/* Use flex-grow to expand the search input */}
          ...
          <div className="">
            <Link
              to="/newRequest"
              className="flex items-center justify-center bg-teal-800 hover:bg-teal-700 focus:ring-4 focus:ring-teal-800 text-white font-medium rounded-lg text-sm px-4 py-2 transition-all duration-300 ease-in-out focus:outline-none"
            >
              <svg
